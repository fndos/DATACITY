...
function d3TimeSeriesSample(container, staticURL, size, source) {
  // example data
  var metricName   = "Temperatura";
  ...
  d3.json("http://127.0.0.1:8000/api/" + source + "/2009-01-01/2013-01-01", function(error, dataset) {
    /*
    * ========================================================================
    *  Prepare data
    * ========================================================================
    ...
    */
      ...
      vis.append("text")
          ...
          .text(metricName + " Mensual") // No usar this para señala el metricName
          .attr("x", (-(height/2)))
          .attr("y", 0)
          .attr("dy", "1em")
